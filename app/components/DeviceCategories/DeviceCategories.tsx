    ...
    <div className="relative h-screen w-screen">
      ...
      <div className="relative flex items-center justify-between w-full">
        <div className="absolute top-5 left-8">
          {isCategorySelected && (
            <IoMdArrowRoundBack
              className="text-4xl text-white cursor-pointer rounded-full bg-gray-800 bg-opacity-80 p-1"
              onClick={() => setIsCategorySelected(false)}
            />
          )}
        </div>
        <h1 className="text-indigo-500 font-semibold text-4xl p-5 mx-auto">
          Modo
        </h1>
        <span className="text-gray-300 font-mono text-2xl pr-10">
          {getCurrentTime()}
        </span>
      </div>
      {/* Controller Section */}

      <div className="px-24 space-y-10 mt-5">
        ...
        {!isCategorySelected ? (
          <div className="flex items-center gap-10">
            <div className="flex flex-col space-y-3 items-center p-5 cursor-pointer">
              ...
              <h3 className="text-white font-bold text-2xl">Music</h3>
            </div>
            ...
            >
              ...
              <h3 className="text-white font-bold text-2xl">Lighting</h3>
            </div>
          </div>
        ) : (
          <LightingController />
